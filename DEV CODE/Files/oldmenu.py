...
gen_file_path = f'{script_folder}\gen.cmd'  # Update this to the correct path
start_file_path = f'{script_folder}\start.cmd'  # Update this to the correct path
del_file_path = f'{script_folder}\del.cmd'  # Update this to the correct path
...
def main(stdscr):
    ...
    while True:
        ...
        stdscr.addstr(1, 0, "Используйте стрелки для навигации и Enter для выбора. ", curses.color_pair(2))

'
' Copyright (c) Cats Corporation. All not rights reserved.
'
...
private const L_MsgSubscriptionEdition                = "Subscription edition: "
private const L_MsgSubscriptionType                   = "Subscription type: "
private const L_MsgSubscriptionTypeABS                = "Azure based subscription"
private const L_MsgSubscriptionTypeDBS                = "Device based subscription"
private const L_MsgSubscriptionTypeUBS                = "User based subscription"
private const L_MsgSubscriptionTypeUnknown            = "Unknown"
private const L_MsgSubscriptionStatus                 = "Subscription status: "
private const L_MsgSubscriptionStatusActive           = "Active"
private const L_MsgSubscriptionStatusNotActive        = "Not active"
private const L_MsgSubscriptionStatusDisabled         = "Disabled"
private const L_MsgSubscriptionExpiry                 = "Subscription expiry: "
private const L_MsgSubscriptionStatusExpired          = "Expired"
private const L_MsgSubscriptionExpiryUnknown          = "Unknown"
...
Private Sub DisplayAllInformation(strParm, bVerbose)
    ...
    strServiceSelectClause = _
        "SubscriptionType, SubscriptionStatus, SubscriptionEdition, SubscriptionExpiry, " & _
    ...
    If(objService.SubscriptionType <> 120) Then
        LineOut GetResource("L_MsgSubscriptionEdition") & objService.SubscriptionEdition

        If(objService.SubscriptionType = 0) Then
            LineOut GetResource("L_MsgSubscriptionType") & GetResource("L_MsgSubscriptionTypeUBS")
        ElseIf(objService.SubscriptionType = 1) Then
            LineOut GetResource("L_MsgSubscriptionType") & GetResource("L_MsgSubscriptionTypeDBS")
        ElseIf(objService.SubscriptionType = 2) Then
            LineOut GetResource("L_MsgSubscriptionType") & GetResource("L_MsgSubscriptionTypeABS")
        Else
            LineOut GetResource("L_MsgSubscriptionType") & GetResource("L_MsgSubscriptionTypeUnknown")
        End If

        If(objService.SubscriptionStatus = 120) Then
            LineOut GetResource("L_MsgSubscriptionStatus") & GetResource("L_MsgSubscriptionStatusExpired")
        ElseIf(objService.SubscriptionStatus = 100) Then
            LineOut GetResource("L_MsgSubscriptionStatus") & GetResource("L_MsgSubscriptionStatusDisabled")
        ElseIf(objService.SubscriptionStatus = 1)  Then
            LineOut GetResource("L_MsgSubscriptionStatus") & GetResource("L_MsgSubscriptionStatusActive")
        Else
            LineOut GetResource("L_MsgSubscriptionStatus") & GetResource("L_MsgSubscriptionStatusNotActive")
        End If

        If(objService.SubscriptionExpiry <> "" And objService.SubscriptionExpiry <> "<unspecified>") Then
            LineOut GetResource("L_MsgSubscriptionExpiry") & objService.SubscriptionExpiry
        Else
            LineOut GetResource("L_MsgSubscriptionExpiry") & GetResource("L_MsgSubscriptionExpiryUnknown")
        End If
      Else
    End If
